...
function buildTable(data) {
  ...
  data.forEach((dataRow) => {
    ...
    // reference one object from the array of UFO sightsing, and the values to go into dataRow (one object per row)
...
function updateFilters() {
    ...
    // maybe do let elementVariable=d3.select(any)property.('value') instead of 4b, combining 4a and 4b to one code
